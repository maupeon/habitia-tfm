...
1. `exportar_paquete()` -- una vez, con `DATOS/` completo. Congela en una carpeta todo lo que
...
Desde la raíz del repositorio:
    ...
    python -m src.predictor predecir DATOS/data/api_idealista/madrid_ciudad_venta.json -o predicciones.csv
...
RUTA_ARTEFACTO = RAIZ / "DATOS" / "modelos" / "produccion.joblib"
RUTA_ZIP = RAIZ / "dist" / "habitia_predictor.zip"
MODULOS_PREDICCION = ["predictor.py", "produccion.py", "amenidades_descripcion.py"]
PROCESADOS = RAIZ / "DATOS" / "data" / "processed"
VERSION_PAQUETE = 3
...
- Amenities como terraza o aire acondicionado se leen de la descripción: lo que el
